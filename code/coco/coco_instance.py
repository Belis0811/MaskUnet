...
train_dataset = COCOSegmentationDataset(json_file=os.path.join(TRAIN_PATH,'annotations/instances_train2017.json'), image_dir=os.path.join(TRAIN_PATH,'train2017'))
val_dataset = COCOSegmentationDataset(json_file=os.path.join(TRAIN_PATH,'annotations/instances_val2017.json'), image_dir=os.path.join(TRAIN_PATH,'val2017'))
